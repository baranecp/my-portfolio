...
const About = forwardRef<HTMLDivElement>((props, ref) => {
  return (
    <section
      id='about'
      ref={ref}
      className='flex flex-col lg:flex-row items-center justify-center min-h-screen px-8 py-20 gap-8'>
      <div className='flex flex-col gap-6 max-w-2xl'>
        ...
        <p>
          ...
          worked as an electronics technician, and served in the army as a radio
          operator/signaller. Programming quickly became my passion.
        </p>
        <p>
        ...
        <p>
          ...
          games, or watching anime — things that keep me inspired and balanced.
        </p>
      </div>
